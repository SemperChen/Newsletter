    ...
    return (
      <View
        ...
        <View style={{flexDirection: 'row'}}>
          ...
          <View style={styles.btnContainer}>
            <TouchableOpacity style={[styles.btn, {borderWidth: 0}]}>
              <Text style={{color: '#fff', fontSize: 18}}>
                {this.state.readerFontSize}
              </Text>
            </TouchableOpacity>
          </View>
          <View style={styles.btnContainer}>
        ...
        <View style={{flexDirection: 'row'}}>
          <View style={styles.btnContainer}>
            <TouchableOpacity
              style={[
                styles.btn,
                this.state.lHIndex === 0 ? {borderColor: selectedColor} : {},
              ]}
              onPress={() => {
          ...
          <View style={styles.btnContainer}>
            <TouchableOpacity
              style={[
                styles.btn,
                this.state.lHIndex === 1 ? {borderColor: selectedColor} : {},
              ]}
              onPress={() => {
          ...
          <View style={styles.btnContainer}>
            <TouchableOpacity
              style={[
                styles.btn,
                this.state.lHIndex === 2 ? {borderColor: selectedColor} : {},
              ]}
              onPress={() => {
              ...
              <Text style={{color: '#fff', fontSize: 40, lineHeight: 38}}>
                =
              </Text>
            </TouchableOpacity>
          </View>
