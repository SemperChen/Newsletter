...
export const reservedH =
  DeviceInfo.getModel().indexOf('iPhone X') !== -1 ? 60 : 0;
          ...
          onLayout={e => {
            ...
            if (height < MAXH) {
              this.setState(prevState => ({
                text: prevState.text + WRAP,
                height: height,
              }));
              this.line++;
            } else if (this.state.fontSize <= maxFontSize) {
              this.textHeight.push({
                fontSize: this.state.fontSize,
              ...
              this.textHeightData.push({
                lineHeight: this.state.lineHeight,
                textHeight: this.textHeight,
              });
              this.setState({
                lineHeight:
                  this.state.lineHeight + lineHeights[1] - lineHeights[0],
                fontSize: minFontSize,
                text: '我',
              });
              this.line = 0;
