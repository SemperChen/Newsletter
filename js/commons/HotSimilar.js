...
class HotSimilar extends React.Component {
  ...
  componentDidMount() {
    ...
    let url =
      'http://api.zhuishushenqi.com/book/by-categories?major=' +
      this.major +
      '&start=0&gender=' +
      this.sex +
      '&type=hot';
  ...
  shouldComponentUpdate(nextProps, nextState) {
    return (
      this.props.hotSimilarData !== nextProps.hotSimilarData ||
  ...
  render() {
    ...
    return this.props.hotSimilarData && this.books ? (
            ...
            return (
              <TouchableHighlight
                ...
                onPress={() => {
                  ...
                  this.props.dispatch(
                    requestDetail(BOOK_DETAIL_BASE + item._id),
                  );
      ...
      <Loading size={'small'} animating={true} />
    );
  }
}
