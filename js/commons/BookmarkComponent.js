  ...
  render() {
    return (
      <TouchableHighlight
        underlayColor="#fff"
        onLongPress={() => {
          this.props.showIsDeleteBookmark(
            this.props.bookmark.tag,
            this.props.bookmark.bookName,
            this.props.bookmark.siteName,
          );
        }}
        onPress={() => {
        ...
        <View>
          <View style={styles.bookImageContainer}>
            <FastImage
              source={{uri: this.props.bookmark.image}}
              style={styles.bookImage}
            />
          </View>

          <Text numberOfLines={2} style={styles.bookName}>
            {getChineseText(this.props.bookmark.bookName)}
          </Text>
        </View>
      </TouchableHighlight>
    );
