...
class ReaderMenuFooter extends React.Component {
    ...
    render() {
        ...
        return (
            <Animated.View style={{bottom: this.animatedValue, position: 'absolute', zIndex: 100}}>
                <View>
                    <View style={styles.menu}>
                        ...
                        <TouchableOpacity
                            ...
                            <View style={styles.menuItem}>
                                <MaterialIcons name="cloud-download" size={this.bottomMenuIconSize}
                                               style={styles.menuIcon}/>
                                <Text style={{color: '#fff', fontSize: 10}}>{I18n.t('cache')}</Text>
                            </View>
                        </TouchableOpacity>
