...
class ReaderMenuSet extends React.Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    return (
      this.state.showPinkSkin !== nextState.showPinkSkin ||
      ...
      this.state.isOpenVoice !== nextState.isOpenVoice ||
        ...
        <View style={styles.readerSet}>
          <View
            ...
            <Text
              ...
              style={{color: '#fff', fontSize: this.state.sampleFontSize}}>
              {I18n.t('readFontSize')}
            </Text>
          </View>
          ...
          <View
            ...
            <TouchableHighlight
              underlayColor={this.brown}
              onPress={() => {
                this.setBgColor(READ_BG_COLOR.DEFAULT);
              }}
              style={[
                menuSetStyles.readerSkinButton,
                {backgroundColor: this.brown},
                this.state.showBrownSkin
                  ? menuSetStyles.selectedBorderColor
                  : menuSetStyles.unSelectBorder,
              ]}>
              <MaterialIcons
                name="check"
                size={this.state.showBrownSkin ? this.bottomMenuIconSize : 0}
                style={[menuSetStyles.skinIcon]}
              />
            </TouchableHighlight>
            <TouchableHighlight
              underlayColor={this.blue}
              onPress={() => {
              ...
              style={[
                ...
                this.state.showBlueSkin
                  ? menuSetStyles.selectedBorderColor
                  : menuSetStyles.unSelectBorder,
              ]}>
              <MaterialIcons
                name="check"
                size={this.state.showBlueSkin ? this.bottomMenuIconSize : 0}
                style={[menuSetStyles.skinIcon]}
              />
            </TouchableHighlight>
            <TouchableHighlight
              underlayColor={this.green}
              onPress={() => {
              ...
              style={[
                ...
                this.state.showGreenSkin
                  ? menuSetStyles.selectedBorderColor
                  : menuSetStyles.unSelectBorder,
              ]}>
              <MaterialIcons
                name="check"
                size={this.state.showGreenSkin ? this.bottomMenuIconSize : 0}
                style={[menuSetStyles.skinIcon]}
              />
            </TouchableHighlight>
            <TouchableHighlight
              underlayColor={this.pink}
              onPress={() => {
              ...
              style={[
                ...
                this.state.showPinkSkin
                  ? menuSetStyles.selectedBorderColor
                  : menuSetStyles.unSelectBorder,
              ]}>
              <MaterialIcons
                name="check"
                size={this.state.showPinkSkin ? this.bottomMenuIconSize : 0}
                style={[menuSetStyles.skinIcon]}
              />
            </TouchableHighlight>
          </View>
          ...
          <View
            ...
            <TouchableHighlight
              style={menuSetStyles.readerModeButton}
              onPress={() => {
                this.props.clearBookCache();
              }}>
              <Text style={{color: '#fff'}}>
                {getChineseText('清除本书缓存')}
              </Text>
            </TouchableHighlight>
          </View>
        </View>
