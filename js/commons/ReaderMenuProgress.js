            ...
            <View ref={(ref) => {
                ...
                <View style={styles.readerSet}>
                    <View style={{flexDirection:'row',alignItems: 'center'}}>
                        <TouchableOpacity
                            onPress={()=>{
                                if(this.state.currentChapterNum>1){
                                    this.props.fetchArticleByProgress(this.state.currentChapterNum-2)
                                }
                        ...
                        <TouchableOpacity
                            onPress={()=>{
                                if(this.state.currentChapterNum<this.props.catalogDataLength ){
                                    this.props.fetchArticleByProgress(this.state.currentChapterNum)
                                }
                            }}
                        >
