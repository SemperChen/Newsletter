  ...
  render() {
    ...
    return (
      <ScrollableTabView
        ...
        <WeekRanking
          tabLabel={I18n.t('weekRanking')}
          weekRankUrl={this.weekRankUrl}
          navToDetail={this._navToDetail}
        />
        <MonthRanking
          tabLabel={I18n.t('monthRanking')}
          monthRankUrl={this.monthRankUrl}
          navToDetail={this._navToDetail}
        />
        <TotalRanking
          tabLabel={I18n.t('totalRanking')}
          totalRankUrl={this.totalRankUrl}
          navToDetail={this._navToDetail}
        />
      </ScrollableTabView>
    );
