    ...
    Alert.alert(
      ...
      [
        {text: I18n.t('cancel'), style: 'cancel'},
        {
          text: I18n.t('del'),
          onPress: () => {
            this._removeAndReLoadBookmark('bookmark', tag).then(
              this.props._onRefresh(),
            );
        ...
        <ScrollView
          ...
          {sortBookmarks && sortBookmarks.length !== 0 ? (
            <View
              ...
              <View style={styles.bookImage}>
                <FastImage
                  source={{uri: sortBookmarks[0].image}}
                  style={[
                    styles.bookImage,
                    {
                      position: 'absolute',
              ...
              <View
                ...
                <Text
                  ...
                  {sortBookmarks[0].bookName}
                </Text>
                <Text style={{marginBottom: 10, color: '#eee'}}>
                  作者：{sortBookmarks[0].author}
                </Text>
                <Text style={{marginBottom: 10, color: '#eee'}}>
                  进度：
                  {sortBookmarks[0].chapterName
                    ? sortBookmarks[0].chapterName
                    : '无'}
                </Text>
              </View>
          ...
          <View style={[{padding: WIDTH / 24}, styles.container]}>
            {sortBookmarks && sortBookmarks.length !== 0 ? (
              ...
              <Text style={styles.notBookmark}>
                {I18n.t('notSaveBookmark')}
              </Text>
            )}
          </View>
          {/*<MeasureText/>*/}
