...
class CategoryDetailPage extends React.Component {
  ...
  componentDidMount() {
    ...
    this.otherTypes = [
      {type: 'hot', title: I18n.t('hot')},
      {type: 'reputation', title: I18n.t('reputation')},
      {type: 'new', title: I18n.t('newBook')},
      {type: 'over', title: I18n.t('over')},
    ];
  ...
  shouldComponentUpdate(nextProps) {
    return !(
      this.props.categoryDetailData === nextProps.categoryDetailData &&
  ...
  render() {
    console.log('this.props.categoryDetailData', this.props.categoryDetailData);
            ...
            refreshControl={
              <RefreshControl
                ...
                progressBackgroundColor={
                  RefreshControlColor.progressBackgroundColor
                }
              />
            }
  ...
  _renderItem = ({item}) => {
    return <BookItem navToDetail={this._navToDetail} book={item} />;
  };
