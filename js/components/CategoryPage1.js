    ...
    static navigationOptions = ({navigation, screenProps}) => ({
        tabBarLabel: ({focused}) => (
            <Text style={[{
                ...
                {color: screenProps.appTheme.darkColor} :
                {color: screenProps.appTheme.lightColor}]}>{I18n.t('category')}</Text>
        ),
        tabBarIcon: ({focused}) => (
            <MaterialIcons name="apps" size={TAB_ICON_SIZE}
                           style={focused ?
                               {color: screenProps.appTheme.darkColor} :
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity
                                ...
                                style={[{
                                    ...
                                    flexDirection: 'row'
                                }, this.state.isMale ? {backgroundColor: '#eee'} : {backgroundColor: '#fff',}]}>
                                {this.state.isMale ? <Text style={{
                                    height: '100%',
                                    width: 5,
                                    position: 'absolute',
                                    left: 0,
                        ...
                        <View style={{height:'100%'}}>
                            <ScrollView
                                ...
                                <View>
                                    ...
                                    <View style={{}}>
                                        <Text style={{paddingLeft: 30, marginVertical: 10}}>男生小说</Text>
                                                ...
                                                return (
                                                    <TouchableOpacity
                                                        ...
                                                        <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                                            ...
                                                            <Text style={{marginLeft: 10}}>{getChineseText(item.major)}</Text>
                                                        </View>
                                                    </TouchableOpacity>
                                                )
                                            })}
                                        </View>
                                        <Text style={{paddingLeft: 30, marginVertical: 10}}>女生小说</Text>
