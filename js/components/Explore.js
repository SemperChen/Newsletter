      ...
      <ScrollView style={{flex: 1, backgroundColor: '#fafafa'}}>
        ...
        <TouchableOpacity
          ...
          <View style={[styles.imgContent, {backgroundColor: '#fff'}]}>
            <Icon name="md-person" size={40} color={appTheme.primaryColor} />
          </View>
          <Text style={{color: '#fff'}}>
            {NovelAppConfig.user && NovelAppConfig.user.username
              ? NovelAppConfig.user.username
              : '游客'}
          </Text>
        </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <View style={styles.item}>
              <View style={styles.itemLeft}>
                ...
                />
                <Text style={styles.itemLeftText}>
                  {getChineseText('观看视频暂停广告')}
                </Text>
              </View>
              <Icon name="ios-arrow-forward" size={20} color="#ddd" />
            </View>
          </TouchableOpacity>
        ) : null}
      </ScrollView>
