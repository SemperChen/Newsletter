...
import {
  clearRankingDetailCache,
  requestRankingDetail,
} from '../actions/rankingDetail';
...
class WeekRanking extends React.Component {
  componentDidMount() {
    InteractionManager.runAfterInteractions(() => {
      this.props.dispatch(
        requestRankingDetail(this.props.weekRankUrl, RANKING_TYPE.WEEK),
      );
    });
  }
  ...
  _renderItem = ({item}) => {
    return <BookItem navToDetail={this.props.navToDetail} book={item} />;
  };
