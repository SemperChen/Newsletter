...
class CatalogPage1 extends React.Component {
    ...
    render() {
        ...
        return (
            <Animated.View style={[styles.catalogContainer,{position:'absolute',left:this.animatedValue}]}>
    ...
    _onViewableItemsChanged = () => {
        ...
        if (this.props.currentChapterNum && globalData.catalog.length > 0 && !this.isFetched) {
            this.isFetched = true;
            try {
